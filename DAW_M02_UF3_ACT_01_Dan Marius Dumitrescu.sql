...
CREATE USER secre1 IDENTIFIED BY "world1234" DEFAULT TABLESPACE academia QUOTA 
UNLIMITED ON academia; 

CREATE USER secre2 IDENTIFIED BY "world1234" DEFAULT TABLESPACE academia QUOTA 
UNLIMITED ON academia; 
